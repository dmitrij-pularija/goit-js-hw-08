...
function createGallery() {
    const items = [];
    for (const galleryItem of (0, _galleryItemsJs.galleryItems)){
...
function esc(event) {
    event.preventDefault();
    if (event.code === "Escape") document.removeEventListener("keydown", esc);
}

},{"./gallery-items.js":"e9dXm","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"e9dXm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"kaxSc":[function() {},{}]},["a1WKf","9de4I"], "9de4I", "parcelRequire4c75")
